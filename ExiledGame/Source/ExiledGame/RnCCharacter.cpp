...
#include "Controllers/RnCPlayerController.h"
...
ARnCCharacter::ARnCCharacter()
{
	...
	// TODO: Is this the correct transform rule here?
	...
	// TODO: Is this the correct transform rule?
	FollowCamera->AttachToComponent(CameraBoom, FAttachmentTransformRules::SnapToTargetIncludingScale, USpringArmComponent::SocketName); // Attach the camera to the end of the boom and let the boom adjust to match the controller orientation
