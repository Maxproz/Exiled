...
void AJumpNode::ActorBeginOverlap(AActor* MyActor, AActor* OverlapedActor)
{
...
void AJumpNode::ActorEndOverlap(AActor* MyActor, AActor* OtherActor)
{
...
AJumpNode::AJumpNode()
{
	...
	// TODO: is this right?
	JumpNodeSM->AttachToComponent(BoxComp, FAttachmentTransformRules::KeepRelativeTransform);
