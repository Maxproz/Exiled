...
UCLASS()
class EXILEDGAME_API AJumpNode : public AActor
{
	GENERATED_BODY()
	
private:
	UFUNCTION()
	void ActorBeginOverlap(AActor* MyActor, AActor* OverlapedActor);

	UFUNCTION()
	void ActorEndOverlap(AActor* MyActor, AActor* OtherActor);
