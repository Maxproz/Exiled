...
#include "Environment/JumpNode.h"
#include "Environment/ProjectileBounceArea.h"
...
UCLASS(config = Game)
class EXILEDGAME_API ARnCCharacter : public ACharacter
{
	GENERATED_BODY()
...
public:
	...
	void SetJumpNode(AJumpNode* JumpNodee) { this->JumpNode = JumpNodee; }
