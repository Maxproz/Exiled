...
void UWeaponsComponent::BeginPlay()
{
	...
	if (MainChar)
	{
		...
		for (auto It = AvailableWeaponBlueprintReferences.CreateIterator(); It; It++)
		{
			...
			// TODO: No idea if this new code works.
			WeaponRef->AttachToComponent(MainChar->GetMesh(),  FAttachmentTransformRules::SnapToTargetIncludingScale, WeaponRef->GetCharacterSocket());
